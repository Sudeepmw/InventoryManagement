...
import com.inventorymanagementsystem.JavaClasses.ViewOrdersDescriptionActivity;
    ...
    public View getView(final int pos, View view, ViewGroup viewGroup)
    {
        ...
        card_view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(cnt, ViewOrdersDescriptionActivity.class);
        ...
        tv_restaurent_name.setText("Restaurant Name  :"+ar.get(pos).getRestaurant_name());
