...
public class DeliveredItemsAdminActivity extends AppCompatActivity {
    ...
    public void serverData(){
        ...
        Call<List<DeliveredItems>> call = service.getAdminDeliveredItems();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.idlogout:
                final AlertDialog.Builder builder = new AlertDialog.Builder(DeliveredItemsAdminActivity.this);
